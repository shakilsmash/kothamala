...
public class KothamalaApplication {
    ...
    private static final Logger log = LoggerFactory.getLogger(KothamalaApplication.class);
    ...
    /**
     * Main method, use to run the application.
     *
     * @param args the command line arguments
     * @throws UnknownHostException if the local host name could not be resolved into an address
     */
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KothamalaApplication.class);
